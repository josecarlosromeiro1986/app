...
import { View, Image, Text, TextInput, StyleSheet, AsyncStorage, TouchableOpacity, ScrollView, ActivityIndicator, SafeAreaView } from 'react-native'
      ...
      <ScrollView style={style.scrollView}>
        ...
        <View style={style.form}>
          ...
          <TouchableOpacity onPress={BackIndex}>
            ...
            <ActivityIndicator size="large" color="#028134" animating={true}/>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView >
